...
switch_slot_index (GstElement * tensor_repo)
{
  ...
  g_message ("current active memory slot is  : %d and it is changed to %d\n",
...
main (int argc, char *argv[])
{
  ...
  g_timeout_add (200, (GSourceFunc) switch_slot_index, tensor_reposink);
  g_timeout_add (200, (GSourceFunc) switch_slot_index, tensor_reposrc);
