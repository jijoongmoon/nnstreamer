  ...
  switch (option.test_type) {
    ...
    case TEST_TYPE_CUSTOM_TENSOR:
      ...
      str_pipeline =
          g_strdup_printf
          ("videotestsrc num-buffers=%d ! videoconvert ! video/x-raw,width=160,height=120,format=RGB,framerate=(fraction)30/1 ! "
          "tensor_converter ! tensor_filter framework=custom model=%s/nnstreamer_example/custom_example_passthrough/libnnstreamer_customfilter_passthrough_variable.so ! tensor_sink name=test_sink",
	   option.num_buffers, parent_dir);
      break;
    case TEST_TYPE_CUSTOM_TENSORS:
      /** other/tensors with tensormux, passthrough custom filter */
      str_pipeline =
          g_strdup_printf
          ("tensor_mux name=mux ! tensor_filter framework=custom model=%s/nnstreamer_example/custom_example_passthrough/libnnstreamer_customfilter_passthrough_variable.so ! tensor_sink name=test_sink "
          "videotestsrc num-buffers=%d ! video/x-raw,width=160,height=120,format=RGB,framerate=(fraction)30/1 ! tensor_converter ! mux.sink_0 "
          ...
          "videotestsrc num-buffers=%d ! video/x-raw,width=64,height=48,format=RGB,framerate=(fraction)30/1 ! tensor_converter ! mux.sink_2",
	   parent_dir, option.num_buffers, option.num_buffers, option.num_buffers);
      break;
    case TEST_TYPE_CUSTOM_BUF_DROP:
      ...
      str_pipeline =
          ...
          "tensor_converter frames-per-tensor=200 ! tensor_filter framework=custom model=%s/tests/libnnscustom_drop_buffer.so ! tensor_sink name=test_sink",
	   option.num_buffers, parent_dir);
      break;
    ...
    case TEST_TYPE_ISSUE739_MUX_PARALLEL_1:
      ...
      str_pipeline =
          g_strdup_printf
          ("videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=10/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_0 "
          "videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=25/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_1 "
          "tensor_mux sync_mode=slowest name=mux ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! tee name=t ! queue ! tensor_sink sync=true name=test_sink t. ! queue ! filesink location=%s",
	   option.num_buffers * 10, parent_dir, option.num_buffers * 25, parent_dir, parent_dir,  option.tmpfile);
      break;
    case TEST_TYPE_ISSUE739_MUX_PARALLEL_2:
      ...
      str_pipeline =
          ...
          ("videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=10/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_0 "
          "videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=25/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_1 "
          "tensor_mux sync_mode=basepad sync_option=0:0 name=mux ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! tee name=t ! queue ! tensor_sink sync=true name=test_sink t. ! queue ! filesink location=%s",
	   option.num_buffers * 10, parent_dir, option.num_buffers * 25, parent_dir, parent_dir, option.tmpfile);
      break;
    case TEST_TYPE_ISSUE739_MUX_PARALLEL_3:
      ...
      str_pipeline =
          ...
          ("videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=10/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_0 "
          "videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=25/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_1 "
          "tensor_mux sync_mode=basepad sync_option=1:0 name=mux ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! tee name=t ! queue ! tensor_sink sync=true name=test_sink t. ! queue ! filesink location=%s",
	   option.num_buffers * 10, parent_dir, option.num_buffers * 25, parent_dir, parent_dir,  option.tmpfile);
      break;
    case TEST_TYPE_ISSUE739_MUX_PARALLEL_4:
      ...
      str_pipeline =
          ...
          ("videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=10/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_0 "
          "videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=25/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_1 "
          "tensor_mux sync_mode=basepad sync_option=1:1000000000 name=mux ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! tee name=t ! queue ! tensor_sink sync=true name=test_sink t. ! queue ! filesink location=%s",
	   option.num_buffers * 10, parent_dir, option.num_buffers * 25, parent_dir, parent_dir,  option.tmpfile);
      break;
    case TEST_TYPE_ISSUE739_MERGE_PARALLEL_1:
      ...
      str_pipeline =
          ...
          ("videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=10/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_0 "
          "videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=25/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_1 "
          "tensor_merge mode=linear option=3 sync_mode=slowest name=mux ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! tee name=t ! queue ! tensor_sink sync=true name=test_sink t. ! queue ! filesink location=%s",
	   option.num_buffers * 10, parent_dir, option.num_buffers * 25, parent_dir, parent_dir, option.tmpfile);
      break;
    case TEST_TYPE_ISSUE739_MERGE_PARALLEL_2:
      ...
      str_pipeline =
          ...
          ("videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=10/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_0 "
          "videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=25/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_1 "
          "tensor_merge mode=linear option=3 sync_mode=basepad sync_option=0:0 name=mux ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! tee name=t ! queue ! tensor_sink sync=true name=test_sink t. ! queue ! filesink location=%s",
	   option.num_buffers * 10, parent_dir, option.num_buffers * 25, parent_dir, parent_dir, option.tmpfile);
      break;
    case TEST_TYPE_ISSUE739_MERGE_PARALLEL_3:
      ...
      str_pipeline =
          ...
          ("videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=10/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_0 "
          "videotestsrc pattern=snow num-buffers=%d ! video/x-raw,format=BGRx,height=4,width=4,framerate=25/1 ! tensor_converter ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! mux.sink_1 "
          "tensor_merge mode=linear option=3 sync_mode=basepad sync_option=1:0 name=mux ! tensor_filter framework=custom model=%s/tests/libnnscustom_framecounter.so ! tee name=t ! queue ! tensor_sink sync=true name=test_sink t. ! queue ! filesink location=%s",
	   option.num_buffers * 10, parent_dir, option.num_buffers * 25, parent_dir, parent_dir, option.tmpfile);
      break;
...
main (int argc, char **argv)
{
  ...
  for(optind = 1; optind < argc && argv[optind][0] == '-'; optind++){
    ...
    case 'd': strcpy(parent_dir, argv[optind+1]); break;
    default:
      break;
    }
  }
